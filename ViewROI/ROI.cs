...
namespace ViewROI
{
	...
	public class ROI
	{
        ...
        public bool isSearchRegion = true;
		/// <summary>
		...
		public virtual void draw(HalconDotNet.HWindow window,bool include) { }

        /// <summary>
        /// 返回是否是搜索区域
        /// </summary>
        /// <returns></returns>
        public virtual bool GetIsSearchRegion()
        {
        ...
        public virtual void SetCenterIndex()
        { 
